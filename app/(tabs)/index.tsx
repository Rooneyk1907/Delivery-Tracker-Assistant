...
export default function Index() {
	...
	// State for history page management
	const [filteredDays, setFilteredDays] = useState<WorkDay[]>();
	const [visible, setVisible] = useState<boolean>(false);
	const [selected, setSelected] = useState<filterSelectorItem>();
	...
	const selectorData = [
		...
		{
			label: 'Past Month',
			value: 'prevMonthRolling',
		},
		{
			label: 'Previous Month',
			value: 'prevMonthCalendar',
		},
		{
			label: 'Year to Date',
			value: 'yearToDate',
