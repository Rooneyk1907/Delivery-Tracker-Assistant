...
export function calculateShiftDuration(clockInTime: string, clockOutTime:string): string {
...
export function calculateDashboardMetrics(workDays: WorkDay[]): DashboardMetrics {
