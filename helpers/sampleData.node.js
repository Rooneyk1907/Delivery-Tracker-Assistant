...
function createOrderWithinShift(date, orderId, startMinute, totalDurationSeconds) {
...
function createOrdersForShift(date, shift, firstOrderId) {
  ...
  const estimatedOrders = Math.round((shiftDurationMinutes / 60) * randFloat(1.2, 2.2));
